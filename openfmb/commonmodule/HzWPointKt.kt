...
public object HzWPointKt {
  ...
  @kotlin.PublishedApi
    ...
    public var deadbandHzVal: kotlin.Float
      @kotlin.jvm.JvmName("getDeadbandHzVal")
        get() = _builder.deadbandHzVal
      @kotlin.jvm.JvmName("setDeadbandHzVal")
        set(value) {
        _builder.deadbandHzVal = value
      }
    /**
     * ```
     * This is an absolute value field
    ...
    public var slopeVal: kotlin.Float
      @kotlin.jvm.JvmName("getSlopeVal")
        get() = _builder.slopeVal
      @kotlin.jvm.JvmName("setSlopeVal")
        set(value) {
        _builder.slopeVal = value
      }
    /**
     * ```
     * MISSING DOCUMENTATION!!!
