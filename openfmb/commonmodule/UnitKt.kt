...
public object UnitKt {
  ...
  @kotlin.PublishedApi
    ...
    public val UnitKt.Dsl.multiplierOrNull: openfmb.commonmodule.Optional_UnitMultiplierKind?
    ...
    public var sIUnit: openfmb.commonmodule.UnitSymbolKind
      @kotlin.jvm.JvmName("getSIUnit")
        get() = _builder.siUnit
      @kotlin.jvm.JvmName("setSIUnit")
        set(value) {
        _builder.siUnit = value
      }
    public var sIUnitValue: kotlin.Int
      @kotlin.jvm.JvmName("getSIUnitValue")
        get() = _builder.siUnitValue
      @kotlin.jvm.JvmName("setSIUnitValue")
        set(value) {
        _builder.siUnitValue = value
      }
    /**
     * ```
     * SI unit of measure.
