...
public object QualityKt {
  ...
  @kotlin.PublishedApi
    ...
    public var detailQual: openfmb.commonmodule.DetailQual
      @kotlin.jvm.JvmName("getDetailQual")
        get() = _builder.detailQual
      @kotlin.jvm.JvmName("setDetailQual")
        set(value) {
        _builder.detailQual = value
      }
    /**
     * ```
     * Describes some reasons in case 'validity' is not 'good'.
    ...
    public val QualityKt.Dsl.detailQualOrNull: openfmb.commonmodule.DetailQual?
      get() = _builder.detailQualOrNull
    ...
    public var operatorBlocked: kotlin.Boolean
      @kotlin.jvm.JvmName("getOperatorBlocked")
        get() = _builder.operatorBlocked
      @kotlin.jvm.JvmName("setOperatorBlocked")
        set(value) {
        _builder.operatorBlocked = value
      }
    /**
     * ```
     * (default=false) If true, further update of the value has been blocked by an operator. The value
    ...
    public var test: kotlin.Boolean
      @kotlin.jvm.JvmName("getTest")
        get() = _builder.test
      @kotlin.jvm.JvmName("setTest")
        set(value) {
        _builder.test = value
      }
    /**
    ...
    public var validity: openfmb.commonmodule.ValidityKind
      @kotlin.jvm.JvmName("getValidity")
        get() = _builder.validity
      @kotlin.jvm.JvmName("setValidity")
        set(value) {
        _builder.validity = value
      }
    public var validityValue: kotlin.Int
      @kotlin.jvm.JvmName("getValidityValue")
        get() = _builder.validityValue
      @kotlin.jvm.JvmName("setValidityValue")
        set(value) {
        _builder.validityValue = value
      }
    /**
     * ```
     * Validity of the value, as condensed information for the client. In case this value is not
