...
@kotlin.jvm.JvmName("-initializecapabilityOverrideMessageInfo")
public inline fun capabilityOverrideMessageInfo(block: openfmb.commonmodule.CapabilityOverrideMessageInfoKt.Dsl.() -> kotlin.Unit): openfmb.commonmodule.CapabilityOverrideMessageInfo =
  openfmb.commonmodule.CapabilityOverrideMessageInfoKt.Dsl._create(openfmb.commonmodule.CapabilityOverrideMessageInfo.newBuilder()).apply { block() }._build()
public object CapabilityOverrideMessageInfoKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: openfmb.commonmodule.CapabilityOverrideMessageInfo.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: openfmb.commonmodule.CapabilityOverrideMessageInfo.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): openfmb.commonmodule.CapabilityOverrideMessageInfo = _builder.build()
