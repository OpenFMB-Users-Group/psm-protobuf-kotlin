...
public object CheckConditionsKt {
  ...
  @kotlin.PublishedApi
    ...
    public var interlockCheck: com.google.protobuf.BoolValue
      @kotlin.jvm.JvmName("getInterlockCheck")
        get() = _builder.interlockCheck
      @kotlin.jvm.JvmName("setInterlockCheck")
        set(value) {
        _builder.interlockCheck = value
      }
    /**
     * ```
     * InterlockCheck is used for the device to be controlled to check if other devices are in proper
    ...
    public val CheckConditionsKt.Dsl.interlockCheckOrNull: com.google.protobuf.BoolValue?
      get() = _builder.interlockCheckOrNull
    ...
    public var synchroCheck: com.google.protobuf.BoolValue
      @kotlin.jvm.JvmName("getSynchroCheck")
        get() = _builder.synchroCheck
      @kotlin.jvm.JvmName("setSynchroCheck")
        set(value) {
        _builder.synchroCheck = value
      }
    /**
     * ```
     * To check if a device is synchrous to the system.
    ...
    public val CheckConditionsKt.Dsl.synchroCheckOrNull: com.google.protobuf.BoolValue?
      get() = _builder.synchroCheckOrNull
  }
}
@kotlin.jvm.JvmSynthetic
