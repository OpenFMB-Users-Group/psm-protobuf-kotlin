...
public object ENG_ScheduleParameterKt {
  ...
  @kotlin.PublishedApi
    ...
    public var scheduleParameterType: openfmb.commonmodule.ScheduleParameterKind
      @kotlin.jvm.JvmName("getScheduleParameterType")
        get() = _builder.scheduleParameterType
      @kotlin.jvm.JvmName("setScheduleParameterType")
        set(value) {
        _builder.scheduleParameterType = value
      }
    public var scheduleParameterTypeValue: kotlin.Int
      @kotlin.jvm.JvmName("getScheduleParameterTypeValue")
        get() = _builder.scheduleParameterTypeValue
      @kotlin.jvm.JvmName("setScheduleParameterTypeValue")
        set(value) {
        _builder.scheduleParameterTypeValue = value
      }
    /**
     * ```
     * Schedule parameter type
