...
public object MeterReadingProfileKt {
  ...
  @kotlin.PublishedApi
    ...
    public val MeterReadingProfileKt.Dsl.readingMessageInfoOrNull: openfmb.commonmodule.ReadingMessageInfo?
    ...
    public var meter: openfmb.commonmodule.Meter
      @kotlin.jvm.JvmName("getMeter")
        get() = _builder.meter
      @kotlin.jvm.JvmName("setMeter")
        set(value) {
        _builder.meter = value
      }
    /**
     * ```
     * MISSING DOCUMENTATION!!!
    ...
    public val MeterReadingProfileKt.Dsl.meterOrNull: openfmb.commonmodule.Meter?
      get() = _builder.meterOrNull
    ...
    public var meterReading: openfmb.metermodule.MeterReading
      @kotlin.jvm.JvmName("getMeterReading")
        get() = _builder.meterReading
      @kotlin.jvm.JvmName("setMeterReading")
        set(value) {
        _builder.meterReading = value
      }
    /**
     * ```
     * MISSING DOCUMENTATION!!!
    ...
    public val MeterReadingProfileKt.Dsl.meterReadingOrNull: openfmb.metermodule.MeterReading?
      get() = _builder.meterReadingOrNull
  }
}
@kotlin.jvm.JvmSynthetic
