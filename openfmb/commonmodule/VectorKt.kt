 ...
 * ```
 *
 * Protobuf type `commonmodule.Vector`
 */
public object VectorKt {
  ...
  @kotlin.PublishedApi
    ...
    public var ang: com.google.protobuf.DoubleValue
      @kotlin.jvm.JvmName("getAng")
        get() = _builder.ang
      @kotlin.jvm.JvmName("setAng")
        set(value) {
        _builder.ang = value
      }
    /**
    ...
    public val VectorKt.Dsl.angOrNull: com.google.protobuf.DoubleValue?
      get() = _builder.angOrNull
